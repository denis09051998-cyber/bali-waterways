...
const NAV = [
  ...
  { to: "/kids-swimming-lessons-bali", key: "nav.kids" },
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center flex-wrap gap-1.5">
            <a
              ...
              className="inline-flex items-center gap-1 rounded-full px-2.5 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all hover:brightness-110 hover:shadow-md"
              style={{ background: "linear-gradient(135deg, #F58529, #DD2A7B, #8134AF, #515BD4)" }}
              aria-label="Instagram Russian"
            >
              ...
              <span>Instagram RU</span>
            </a>
            <a
              href={SITE.instagramUrlEn}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 rounded-full px-2.5 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all hover:brightness-110 hover:shadow-md"
              style={{ background: "linear-gradient(135deg, #F58529, #DD2A7B, #8134AF, #515BD4)" }}
              aria-label="Instagram English"
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <rect x="3" y="3" width="18" height="18" rx="5" ry="5" />
                <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden md:inline-flex shrink-0 items-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-[#1ebe57] transition-colors 2xl:px-4"
          >
            ...
            {(() => {
              const raw = lang === "id" ? "Daftar via WhatsApp" : t("cta.book");
              if (lang === "ru") {
                const idx = raw.indexOf(" ");
                if (idx > 0) {
                  return (
                    <span className="flex flex-col leading-tight">
                      <span className="whitespace-nowrap">{raw.slice(0, idx)}</span>
                      <span className="whitespace-nowrap">{raw.slice(idx + 1)}</span>
                    </span>
                  );
                }
              }
