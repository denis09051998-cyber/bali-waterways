...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "UNITY Swimming School Bali" },
      { property: "og:description", content: "UNITY Swimming School Bali — swimming lessons, coaching and freediving across Bali." },
