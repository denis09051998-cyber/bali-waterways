    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/locations/canggu", changefreq: "monthly", priority: "0.8" },
          { path: "/locations/ubud", changefreq: "monthly", priority: "0.8" },
          { path: "/locations/nusa-dua", changefreq: "monthly", priority: "0.8" },
          { path: "/locations/sanur", changefreq: "monthly", priority: "0.8" },
          { path: "/locations/jimbaran-ungasan", changefreq: "monthly", priority: "0.8" },
