    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/kids-swimming-lessons-bali", changefreq: "monthly", priority: "0.9" },
          { path: "/adult-swimming-lessons-bali", changefreq: "monthly", priority: "0.9" },
          { path: "/locations", changefreq: "monthly", priority: "0.8" },
          { path: "/ocean-swimming", changefreq: "monthly", priority: "0.8" },
          { path: "/freediving-bali", changefreq: "monthly", priority: "0.9" },
